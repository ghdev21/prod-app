...
export const INIT_TIMER_IS_FETCHING = 'INIT_TIMER_IS_FETCHING';
export const INIT_TIMER_HAS_FETCHED = 'INIT_TIMER_HAS_FETCHED';
export const START_ITERATION_HAS_FETCHED = 'START_ITERATION_HAS_FETCHED';
export const FINISH_ITERATION_HAS_FETCHED = 'FINISH_ITERATION_HAS_FETCHED';
export const COUNT_DOWN_HAS_FETCHED = 'COUNT_DOWN_HAS_FETCHED';
